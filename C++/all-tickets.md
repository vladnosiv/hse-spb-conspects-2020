...
В общем, случае, нужно передавать функтор, который для `(a, b)` возвращает `true`, когда `a` должен идти *не раньше* `b`. 
...
Если хотите сохранить лямбду, можете сохранить ее в шаблон.## Билет 14
Автор: <Имя Фамилия>
## Билет 15
Автор: <Имя Фамилия>
## Билет 16
